...
public class ProductPage extends AppCompatActivity {
    ...
    String[] pizzeria = {"1441 Pizzeria", "Established in 2015 with a concept to bring the authenticity of Italian wood-fired pizza to India.\n" +
            "\n" +
            "1441 Pizzeria a venture by Trofi Chain Factory Private Limited is the first initiative from this culinary art house. It will be a one of its kind, traditional Italian Wood Fired Pizzeria with all of its food being made solely in the wood oven. The concept and menu have been designed and created by the Italian Pizza Master chef Renato Viola who will also be training the chefs personally.", "@drawable/pizza","Rs. 1000"};
    String[] smokeHouseDeli = {"Smoke House Deli", "We serve comfort food with a deep focus on ethically sourced local ingredients that are healthy, organic, and wholesome. Our produce comes straight from local farms across the country, so that you can enjoy the best of both flavour and health, handmade from scratch.", "@drawable/pizza2","Rs. 1500"};
    String[] mcDonald = {"Mc Donald's", "Everything from Burgers, fries, shakes, wraps to coffee, coolers and amazing beverages ! Back in 1954, a man named Ray Kroc discovered a small burger restaurant in California, and wrote the first page of our history. From humble beginnings as a small restaurant, we're proud to have become one of the world's leading food service brands with more than 36,000 restaurants in more than 100 countries.", "@drawable/burger1","Rs. 700"};
    ...
    String[] chinChinChu = {"Chin Chin Chu", "Comfortable Seating Area, Gastronomical Experience, Fancy Crowd, Family Place, Good Quality Food, Courteous Staff. Come try our Crispy Prawn Cheung Fun, Chili Tofu, Duck Salad, Balinese Curry, Watermelon Drink, Sushi Platter to name a few !", "@drawable/chinese2","Rs. 2200"};
    String[] tapRestro = {"TAP Restro", "\"TAP '' Resto Bar at its best. Tap is an amalgamation of Lounge bar, sports bar, pub & a nightclub. A bold multi faceted venture by China Gate Group. Guests can choose from either unwinding, social gathering, partying hard or indulging themselves in any of featured gaming activities such as Dart machines, pool tables and more.  A new innovative 3 tier menu pricing concept makes it a wallet friendly affair. A haven for foodies showcasing a multi cuisine menu comprising of mexican, conti, indian & chinese offerings", "@drawable/chinese3","Rs. 2500"};
    ...
    String[] newYorkerRestaurant = {"New Yorker Restaurant", "Perfect Location, Relaxed Atmosphere, Ample Seating Area, Decent Ambience, Family Restaurant. Burgers, pizzas, nachos & salads are served at this laid-back quick-serve restaurant.", "@drawable/italian3","Rs. 1400"};

    TextView productTitle, productDes, productPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(name.equals("pizzeria"))
        {
            ...
            productPrice.setText("Price for 2: "+pizzeria[3]);
        ...
        if(name.equals("smokeHouseDeli"))
        {
            ...
            productPrice.setText("Price for 2: "+smokeHouseDeli[3]);
        ...
        if(name.equals("mcDonald"))
        {
            ...
            productPrice.setText("Price for 2: "+mcDonald[3]);
        ...
        if(name.equals("burgerKing"))
        {
            ...
            productPrice.setText("Price for 2: "+burgerKing[3]);
        ...
        if(name.equals("chinChinChu"))
        {
            ...
            productPrice.setText("Price for 2: "+chinChinChu[3]);
        ...
        if(name.equals("tapRestro")) {
            ...
            productPrice.setText("Price for 2: "+tapRestro[3]);
        ...
        if(name.equals("creamCentre")) {
            ...
            productPrice.setText("Price for 2: "+creamCentre[3]);
        ...
        if(name.equals("newYorkerRestaurant")) {
            ...
            productPrice.setText("Price for 2: "+newYorkerRestaurant[3]);
